    ...
    public class AppointmentUnitTest
    {
        ...
        public void Reschedule_Appointment_ReschedulesSuccessfully()
        {
            ...
            Staff staff = new Staff();
            {
                ...
                staff.Position = Enums.StaffPosition.Surgeon;
            }
            ...
            DateTime initialDateTime = new DateTime(2023, 7, 20, 10, 30, 0);
            appointment.Schedule(initialDateTime, 60, pet, staff, "Routine check-up");

            // Act
            DateTime newDateTime = new DateTime(2023, 8, 22, 14, 0, 0);
        ...
        [TestMethod]
        public void Reschedule_Appointment_ReschedulesFailed()
        {
            // Arrange
            ...
            // Act
            DateTime newDateTime = new DateTime(2023, 1, 22, 14, 0, 0);

            // Assert
            Assert.ThrowsException<Exception>(() => appointment.Reschedule(newDateTime));
            Assert.AreEqual(initialDateTime, appointment.DateAndTime);
        }
